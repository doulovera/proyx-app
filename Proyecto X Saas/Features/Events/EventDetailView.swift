        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            if available < 20 && available > 0 {
                HStack {
                    ...
                    Text("¡Solo quedan \(available) entradas disponibles!")
                        .font(.subheadline)
                        .fontWeight(.medium)
                        .foregroundColor(.orange)
                }
    ...
    private var organizerSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            HStack(spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    Text(event.organizer ?? "Organizador")
                        .font(.subheadline)
                        .fontWeight(.semibold)
            ...
            if !event.isFree {
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    HStack {
                        ...
                        Button(action: {
                            let available = event.availableTickets ?? 0
                            if selectedTickets < min(available, 10) {
                                selectedTickets += 1
                            }
                        }) {
                            Circle()
                        ...
                        .disabled(selectedTickets >= min(event.availableTickets ?? 0, 10))
                    }
